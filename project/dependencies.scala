...
//  val spark_streaming_kafka =   ("org.apache.spark" % s"spark-streaming-kafka_${scala_main_version}" % spark_version)
...
//  val zookeeper = ("org.apache.zookeeper" % "zookeeper" % "3.4.6").exclude("org.slf4j", "slf4j-log4j12")
