...
object Ch06_01_Spark_Data_Types {

  val logger = Logger.getLogger(Ch06_01_Spark_Data_Types.getClass)
  ...
  def main(args: Array[String]) {
    ...
    val df = spark.read.format("csv")
      ...
      .load(BASEPATH + "/data/retail-data/by-day/2010-12-01.csv")
    df.printSchema()
    ...
    // in Scala
    val DOTCodeFilter2 = col("StockCode") === "DOT"
    val priceFilter2 = col("UnitPrice") > 600
    val descripFilter2 = col("Description").contains("POSTAGE")
    df.withColumn("isExpensive", DOTCodeFilter2.and(priceFilter2.or(descripFilter2)))
      .where("isExpensive")
